                        ...
                        VStack{
                            ...
                            VStack {
                                ...
                                Text(program.omdbResult?.Plot ?? "")
                                    ...
                                    .font(.subheadline)
                                Divider()
                                Text(program.omdbResult?.Awards ?? "No Awards")
                                    .font(.subheadline)
                                Divider()
                            }
                        }
