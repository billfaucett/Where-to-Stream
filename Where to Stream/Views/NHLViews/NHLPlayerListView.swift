...
struct NHLPLayerListView_Preview: PreviewProvider {
    ...
    static let player4 = Player(id: 3, firstName: Venue(venueDefault: "Drew", fr: "", es: ""), lastName: Venue(venueDefault: "Miller", fr: "", es: ""), sweaterNumber: 6, headshot: "", teamAbbrev: "NYR", teamLogo: "", position: "RW", value: 40)
    static let player5 = Player(id: 3, firstName: Venue(venueDefault: "Kevin", fr: "", es: ""), lastName: Venue(venueDefault: "Fine", fr: "", es: ""), sweaterNumber: 6, headshot: "", teamAbbrev: "PHL", teamLogo: "", position: "RW", value: 40)
